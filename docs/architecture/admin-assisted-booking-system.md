...
| Monthly account (Zoho) | design-only / Phase 1 foundation | — |

See [zoho-monthly-account-billing.md](./zoho-monthly-account-billing.md) for monthly account billing schema and phased rollout (Phase 1 is read-only).
