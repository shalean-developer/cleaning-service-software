...
export const ADMIN_DASHBOARD_NAV_GROUPS: readonly AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/operations/monthly-billing", label: "Monthly billing" },
      { href: "/admin/operations/monthly-collections", label: "Monthly collections" },
      { href: "/admin/operations/monthly-governance", label: "Monthly governance" },
