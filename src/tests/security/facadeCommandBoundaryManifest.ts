...
export const FACADE_BOUNDARY_RULES: FacadeBoundaryRule[] = [
  ...
  {
    facadeFile: "features/assignments/server/adminDeferredDispatchNow.ts",
    exportSymbols: ["runAdminDeferredDispatchNow"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["runAssignmentAfterPayment"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  },
  {
    facadeFile: "features/cleaners/server/lifecycle/deactivateCleaner.ts",
    exportSymbols: ["deactivateCleaner"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["finalizeLifecycleCommand", "updateCleanerLifecycleRow"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  },
  {
    facadeFile: "features/cleaners/server/lifecycle/suspendCleaner.ts",
    exportSymbols: ["suspendCleaner"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["finalizeLifecycleCommand", "updateCleanerLifecycleRow"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  ...
  {
    facadeFile: "features/cleaners/server/lifecycle/reactivateCleaner.ts",
    exportSymbols: ["reactivateCleaner"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["finalizeLifecycleCommand", "updateCleanerLifecycleRow"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  ...
  {
    facadeFile: "features/cleaners/server/lifecycle/unsuspendCleaner.ts",
    exportSymbols: ["unsuspendCleaner"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["finalizeLifecycleCommand", "updateCleanerLifecycleRow"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  ...
  {
    facadeFile: "features/cleaners/server/lifecycle/archiveCleaner.ts",
    exportSymbols: ["archiveCleaner"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["finalizeLifecycleCommand", "updateCleanerLifecycleRow"],
    allowedServiceRoleImport: true,
    allowedDirectWriteException: false,
  ...
  {
    facadeFile: "features/assignments/server/runDeferredAssignmentDispatch.ts",
    exportSymbols: ["runDeferredAssignmentDispatchBatch"],
    tier: "command_required",
    allowedOrchestratorSymbols: ["runAssignmentAfterPayment"],
    allowedServiceRoleImport: false,
    allowedDirectWriteException: false,
...
export const ROUTE_FACADE_SYMBOL_TO_FILE: Record<string, string> = {
  ...
  runAdminDeferredDispatchNow: "features/assignments/server/adminDeferredDispatchNow.ts",
  deactivateCleaner: "features/cleaners/server/lifecycle/deactivateCleaner.ts",
  suspendCleaner: "features/cleaners/server/lifecycle/suspendCleaner.ts",
