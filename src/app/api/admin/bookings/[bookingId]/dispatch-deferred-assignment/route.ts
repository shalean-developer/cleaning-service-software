...
import { runAdminDeferredDispatchNow } from "@/features/assignments/server/adminDeferredDispatchNow";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  const result = await runAdminDeferredDispatchNow(user, bookingId, {
