...
import { CalendarClock, CreditCard, Inbox, PauseCircle, Repeat } from "lucide-react";
...
export function AdminRecurringSummaryCards({ summary }: Props) {
  return (
    <section className={ADMIN_OVERVIEW_SNAPSHOT_SHELL_CLASS} aria-label="Recurring summary">
      <ul className="grid list-none gap-4 p-0 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
        <li>
          <AdminMetricCard
            label="Active series"
        ...
        <li>
          <AdminMetricCard
            ...
            value={String(summary.overdueUnpaidChildrenCount)}
