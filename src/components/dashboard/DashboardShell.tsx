  ...
  return (
    <section className="min-h-screen overflow-x-clip bg-zinc-50">
      <header className="relative border-b border-zinc-200 bg-white">
        <section className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-4 sm:gap-4">
          {showTitleBlock ? (
      ...
      <main className="mx-auto min-w-0 max-w-5xl px-4 py-6 sm:py-8">{children}</main>
    </section>
  );
}
