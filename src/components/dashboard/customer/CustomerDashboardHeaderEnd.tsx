...
type Props = CustomerProfileMenuProps;

/** Optional customer dashboard header actions (profile + notification placeholder). */
export function CustomerDashboardHeaderEnd(props: Props) {
  return (
