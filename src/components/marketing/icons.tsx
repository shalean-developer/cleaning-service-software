...
export function IconUsers({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H2v-2a4 4 0 015-3.87M16 7a4 4 0 11-8 0 4 4 0 018 0zM23 20v-2a4 4 0 00-3-3.87M1 20v-2a4 4 0 013-3.87" />
    </svg>
  );
}
...
export function IconLeaf({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 11c2-3 4-4 8-4" />
    </svg>
  );
}
...
export function IconMapPin({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.2c0 5.7-7.5 11.8-7.5 11.8S4.5 15.9 4.5 10.2a7.5 7.5 0 1115 0z" />
    </svg>
  );
}
...
export function IconCreditCard({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h18v10H3V7zM3 10h18M7 15h4" />
    </svg>
  );
}
